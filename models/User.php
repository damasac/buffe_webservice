...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'auth_key' => Yii::t('app', 'API access token'),
    ...
    public function fields()
    {
        $fields = [
            ...
            'sitecode' => function () {
                return $this->userProfile->sitecode;
            },
            'hospital' => function () {
                $hospital = \Yii::$app->db->createCommand("SELECT zone_code,name from all_hospital_thai where hcode='".$this->userProfile->sitecode."'")->queryOne();
